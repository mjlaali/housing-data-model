...
from housing_data_model.date_model.example import Example, Features, InvalidExample
...
class ExampleParser:
    ...
    def parse(self, standard_input: Dict[str, Any]) -> Optional[Example]:
        ...
        try:
            ...
            example = Example(
                features=Features(
                    house_type=standard_input.get("house_type", "UNKNOWN"),
                    bedroom=standard_input["bedroom"],
                    washroom=standard_input.get("washroom"),
                    parking=standard_input.get("parking/total"),
                    basement=standard_input.get("basement"),
                    map_lat=standard_input.get("map/lat"),
                    map_lon=standard_input.get("map/lon"),
                    date_end=datetime.strptime(standard_input["date_end"], "%Y-%m-%d"),
                    ...
                    seller_price=standard_input["price_int"],
                ),
